    ...
    <div className="flex h-screen bg-gray-900 overflow-hidden">
      ...
      <main className="flex-1 flex flex-col h-screen overflow-y-auto p-4 sm:p-8">
        ...
        <header className="flex items-center justify-between mb-6 pb-4 border-b border-gray-800">
          ...
          <Link href="/usuario/dashboard/vehiculos/nuevoVehiculo" className="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition font-medium shadow-lg shadow-green-900/20">
            Nuevo Vehículo
          </Link>
        </header>
